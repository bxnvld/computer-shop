...
const handleJsonWebTokenError = () => new AppError('Invalid token,please login again');
const handleJsonWebTokenExpiredErro = () => new AppError('Your token has expired.Please log in again');
...
module.exports = (err,req,res,next) => {
    ...
    if(process.env.NODE_ENV === 'development'){
        ...
        if(err.name === 'TokenExpiredError') error = handleJsonWebTokenExpiredErro(error);
