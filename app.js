...
const morgan = require("morgan"); //modify console log for responses
...
// data sanitization against nosql query injections and against xss
...
app.use("/api/v1/purchases", purchasingRouter);
