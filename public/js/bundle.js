    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          _context.next = 4;
          return api.post("/api/v1/users/login", {
            body: {
              email: email,
              password: password
            }
        ...
        case 4:
          ...
          if (res.err) {
            (0, _alerts.showAlert)('error', res.err);
          }
          _context.next = 12;
          break;
        case 9:
          ...
          (0, _alerts.showAlert)('error', _context.t0.responseText);
        case 12:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'Error loging out');
        case 10:
        case "end":
